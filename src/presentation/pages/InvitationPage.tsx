...
const LandingContainer = styled(Box, {
  ...
  opacity: 0,
  transition: 'transform 0.85s cubic-bezier(0.175, 0.885, 0.32, 1.275), opacity 0.6s ease',
  ...(animateIn && {
...
const DateNumber = styled(Typography)({
  ...
  '@keyframes dateNumberGlitch': {
    ...
    '93%': {
      ...
      textShadow: '-4px 0 0 #00f0ff, 4px 0 0 #ff007f, 0 0 15px rgba(255, 28, 36, 0.6)',
    },
    '94%': {
    ...
    '97%': {
      ...
      textShadow: '-3px 0 0 #00f0ff, 3px 0 0 #ff007f, 0 0 15px rgba(255, 28, 36, 0.6)',
    },
    '98%': {
...
const PinSeparatorImg = styled('img')({
  ...
  animation: 'pinBounce 1.6s infinite ease-in-out, multiverseGlitch 4.5s infinite alternate ease-in-out',
  '@keyframes pinBounce': {
...
export const InvitationPage: React.FC = () => {
  ...
  const itineraryData = [
    ...
    },
    {
      ...
      title: "Show & Piñata",
      description:
        "¡Visita especial de Mago y romper la piñata!",
      icon: "show",
    },
        ...
        <>
          ...
          <CardFooter>
            <Typography variant="body2" sx={{ mb: 1 }}>
              Mateo Sebastian | Cumpleaños Número 3 | 5 de Diciembre de 2026
            </Typography>
